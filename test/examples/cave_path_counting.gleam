...
pub fn main() {
  ...
  let assert Ok(graph) = model.add_edge(graph, from: 0, to: 1, with: Nil)
  let assert Ok(graph) = model.add_edge(graph, from: 0, to: 2, with: Nil)
  let assert Ok(graph) = model.add_edge(graph, from: 1, to: 3, with: Nil)
  let assert Ok(graph) = model.add_edge(graph, from: 1, to: 2, with: Nil)
  ...
  let assert Ok(graph) = model.add_edge(graph, from: 4, to: 5, with: Nil)
