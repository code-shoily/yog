...
pub fn main() {
  ...
  let er = generators.erdos_renyi_gnp(100, 0.05)
  ...
  let er2 = generators.erdos_renyi_gnm(100, 250)
  ...
  let ba = generators.barabasi_albert(100, 2)
  ...
  let ws = generators.watts_strogatz(100, 4, 0.1)
  ...
  let tree = generators.random_tree(100)
